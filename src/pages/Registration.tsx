...
import { CheckCircle, FileText, Users, DollarSign, ExternalLink, Download } from "lucide-react";
          ...
          <ContentBox className="mb-8 sm:mb-12">
            ...
            <div className="space-y-8">
              ...
              <Card className="hover:shadow-lg transition-all duration-300">
                <CardHeader>
                  <CardTitle className="text-xl text-primary">Template & Submission</CardTitle>
                </CardHeader>
